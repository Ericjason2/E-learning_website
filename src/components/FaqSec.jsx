...
const FaqSec = () => {
  ...
  return (
    <section className="section pb-[90px] lg:mb-[160px]">
      ...
      >
        <div
          className="grid gap-10 p-5 lg:grid-cols-[0.7fr_1fr]
        items-start bg-white rounded-lg md:p-10"
        >
          {/* Title */}
          <Title
            title="Frequently Asked Questions"
            text="Still you have any questions? 
            Contact our Team via support@skillpath.com"
            link="See All FAQ’s"
          />
          {/* Question wrapper */}
          <div className=" border border-white-95 grid p-6">
            {faqItems.map((item) => (
              ...
              >
                ...
                gap-12 border-b border-white-95 pb-3 md:px-5"
                >
                  <h4 className="text-lg sm:text-xl">{item.title}</h4>
                  <button
                    className="w-10 h-10 bg-orange-75 flex
                  items-center justify-center aspect-square
                  rounded-lg hover:bg-orange-75/80 transition-colors"
