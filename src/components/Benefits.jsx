        ...
        >
          {benefitItems.map((item) => (
            ...
            >
              {/* icon */}
              <div
                className="bg-orange-75 w-[55%] h-24 flex 
              items-center justify-center mx-auto rounded-xl 
              mb-8"
              >
              ...
              {/* button */}
              <button
                className="mt-auto ml-auto border border-white-95
              w-14 h-14 flex items-center justify-center rounded-md 
              text-orange-50 transition-colors hover:bg-orange-50
              hover:text-white"
              >
