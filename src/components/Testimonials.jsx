    ...
    <section className="section">
      ...
      >
        ...
        <motion.div variants={variants.fadeInUp}>
          ...
          >
            {testimonialsItems.map((item) => (
              ...
              <SwiperSlide
                key={item.id}
                className="bg-white border border-white-95 p-8
            lg:p-10 rounded-[10px] space-y-3"
              >
                <p>{item.text}</p>
                <div
        ...
        <motion.div
          ...
          className="flex items-center justify-center mt-18
        gap-5"
        >
          <button
            className="bg-orange-70 w-12 h-12 flex items-center
          justify-center rounded-xl hover:bg-orange-75 transition-colors
